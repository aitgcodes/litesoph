...
def dft_input_file(drop_mode,drop_ftype,drop_basis,spacing,bands,vacuum,cores):
...
def tddft_input_file(drop_strength,drop_pol_x,drop_pol_y,drop_pol_z,dt,Nt,cores):
