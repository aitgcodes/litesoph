...
#       label1 = Canvas.create_text(self,(400, 190), text="Label text")
        ...
        drop_mode.current(0)
        drop_mode['font'] = myFont
        drop_mode.place(x=250,y=10)
        ...
        drop_ftype['font'] = myFont
        drop_ftype.place(x=250, y=50)
        ...
        drop_basis['font'] = myFont
        drop_basis.place(x=250,y=100)
        ...
        entry_spacing['font'] = myFont
        entry_spacing.insert(0,"0.3")
        entry_spacing.place(x= 250, y =150 )
        ...
        entry_bands['font']=myFont
        entry_bands.place(x=250,y=200)
        ...
        entry_vacuum['font'] = myFont
        entry_vacuum.insert(0,"6")
        entry_vacuum.place(x=250,y=250)
