...
class PumpProbePostpro(NwchemTask):
    ...
    def generate_contour_data(self):
        ...
        contour_x_data_file= Path(self.project_dir.name) /'nwchem' / self.task_name/ 'contour_x_data.dat' 
        contour_y_data_file= Path(self.project_dir.name) /'nwchem' / self.task_name/ 'contour_y_data.dat' 
        contour_z_data_file= Path(self.project_dir.name) /'nwchem' / self.task_name/ 'contour_z_data.dat' 
