...
class LabelInput(ttk.Frame):
  ...
  field_types = {
    DT.string: RequiredEntry,
    DT.string_list: ValidatedCombobox,
    DT.short_string_list: ValidatedRadioGroup,
    DT.long_string: BoundText,
    DT.decimal: ValidatedSpinbox,
    DT.integer: ValidatedSpinbox,
    DT.boolean: ttk.Checkbutton
  }
  ...
  def __init__(
    ...
    if field_spec:
      field_type = field_spec.get('type', DT.string)
