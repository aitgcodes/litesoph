...
def runtime_query_fileinfo(host,username,port,passwd,remote_proj_dir,local_proj_dir,job_name):   
    """
    """
    ...
    (error, message)=execute_cmd_lfm(cmd_filesize, passwd)        
    return (error, message)
    
def runtime_query_processinfo(host,username,port,passwd,remote_proj_dir,local_proj_dir,job_name):   
    """
    """
    print("\nRuntime Query Activated !!")
    ...
    (error, message)=execute_cmd_lfm(cmd_check_running_process, passwd)
...
runtime_query_fileinfo(host,username,port,passwd,remote_proj_dir,local_proj_dir,job_name)

runtime_query_processinfo(host,username,port,passwd,remote_proj_dir,local_proj_dir,job_name)
